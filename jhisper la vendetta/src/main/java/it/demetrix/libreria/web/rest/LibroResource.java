...
/**
 * REST controller for managing {@link it.demetrix.libreria.domain.Libro}.
 */
@RestController
@RequestMapping("/api")
public class LibroResource {
    ...
    @GetMapping("/libros/you")
    public ResponseEntity<List<Libro>> getUserBook(Pageable pageable) throws URISyntaxException {
        log.debug("REST request to get a page of Libros");
        Page<Libro> page = libroService.findByAutore(pageable, SecurityUtils.getCurrentUserLogin().orElse(null));
